...
static struct ab8500_regulator_reg_init
	codina_ab8500_reg_init[AB8500_NUM_REGULATOR_REGISTERS] = {
	/*
...
static struct regulator_consumer_supply ab8500_vaux1_consumers[] = {
	...
	REGULATOR_SUPPLY("vdd_bma", "6-0018"),
 ...
 * AB8500 regulators
 */
struct regulator_init_data codina_ab8500_regulators[AB8500_NUM_REGULATORS] = {
 ...
 */
static struct regulator_init_data codina_ext_regulators[] = {
...
struct ab8500_regulator_platform_data codina_ab8500_regulator_plat_data = {
	.reg_init               = codina_ab8500_reg_init,
	.num_reg_init           = ARRAY_SIZE(codina_ab8500_reg_init),
	.regulator              = codina_ab8500_regulators,
	.num_regulator          = ARRAY_SIZE(codina_ab8500_regulators),
	.ext_regulator          = codina_ext_regulators,
	.num_ext_regulator      = ARRAY_SIZE(codina_ext_regulators),
};


/* ab8505 regulator register initialization */
static struct ab8500_regulator_reg_init	codina_ab8505_reg_init[] = {
	/*
	 * VarmRequestCtrl
	 * VsmpsCRequestCtrl
	 * VsmpsARequestCtrl
	 ...
	 * Vaux4Sel                 = 1.8 V
	 */
	INIT_REGULATOR_REGISTER(AB8505_VAUX4SEL,               0x0f, 0x05),
	/*
	 * Vaux1Disch               = short discharge time
	 * Vaux2Disch               = short discharge time
	 * Vaux3Disch               = short discharge time
...
static struct regulator_consumer_supply ab8505_vaux2_consumers[] = {
	REGULATOR_SUPPLY("v-tsp-3.3", "3-0020"),
};
...
static struct regulator_consumer_supply ab8505_vaux5_consumers[] = {
	REGULATOR_SUPPLY("v-tsp-1.8", "3-0020"),
};
 ...
 * AB8505 regulators
 */
struct regulator_init_data codina_ab8505_regulators[AB8505_NUM_REGULATORS] = {
	/* supplies to the Sensors 3V */
	[AB8505_LDO_AUX1] = {
		.constraints = {
			.name = "V-SENSORS-VDD",
