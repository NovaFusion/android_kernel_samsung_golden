 ...
 *
 * @{
 *      @file     mpu6050_input.h
 *      @brief
 */

#ifndef __MPU6050B1_INPUT_H_
#define __MPU6050B1_INPUT_H_

#define MPU_NAME "mpu6050B1"
#define DEFAULT_MPU_SLAVEADDR		0x68

#define MPU6050_INPUT_DRIVER "mpu6050_input"
...
#define MPU6050_MODE_SLEEP	2
#define MPU6050_MODE_WAKE_UP	3
...
#define MPU6050_SENSOR_ACCEL	(0x0f)
#define MPU6050_SENSOR_GYRO	(0xf0)

struct mpu6050_input_platform_data {
	__s8 orientation[9];
