...
#elif defined(CONFIG_TOUCHSCREEN_ZINITIX_BT4X3_ABOVE)
#define	BT4x2_Series		0
#define	BT4x3_Above_Series	1
#else
#error "Valid Zinitix Controller type not configured"
#endif
...
#define	TOUCH_USING_ISP_METHOD	0	/* if you use isp mode,
					you must add i2c device
...
/* ESD Protection  */
#define	ZINITIX_ESD_TIMER_INTERVAL	0	/* second : if 0, no use.
						if you have to use,
						3 is recommended */
